...
subtitle: "Probability, modeling, computation, and evidence"
toc: false
---

![](assets/hero.png){.course-hero-img fig-alt="Course identity banner for Bayesian Statistics — a teal crystal cluster surrounded by Bayesian graphics: Bayes' theorem, a prior-to-posterior update, a posterior predictive band, a 95% credible interval, and an MCMC trace, with the course title."}
...
**Diagnostic build.** This is a draft instructional site generated to exercise the course-building
workflow. Topic flow is in place; dates, weights, and final policies are not sealed and are
authoritative in the LMS.
:::
